...
public class BoardServiceImpl implements BoardService {
	...
	@Override
	@Transactional
	public boolean deleteArticle(int articleno, String userid) throws Exception {
		sqlSession.getMapper(BoardMapper.class).deleteMemo(articleno,userid);
		return sqlSession.getMapper(BoardMapper.class).deleteArticle(articleno,userid) == 1;
	}
